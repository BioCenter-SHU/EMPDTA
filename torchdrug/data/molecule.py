...
class Molecule(Graph):
    ...
    def __init__(self, edge_list=None, atom_type=None, bond_type=None, atom_feature=None, bond_feature=None,
                 ...
                 atom_map=None, bond_stereo=None, stereo_atoms=None, node_position=None, atom_source=None, **kwargs):
        ...
        with self.atom():
            ...
            if atom_source is not None:  # atom_source added for split the atom form molecule and protein
    ...
    def from_molecule(cls, mol, atom_feature="default", bond_feature="default", mol_feature=None,
        ...
        atom_feature = cls._standarize_option(atom_feature)  # returen a list of string like ['default']
        ...
        # if the 2d or 3d positions exist, mol.GetNumConformers() bigger than 0 meaning containing at least a conformer
    ...
    # @property
    # def edge_weight(self):         # added for edge_weight
    #     return self.edge_weight


    # def edge_weight(self, value):  # added for edge_weight
    #     self.edge_weight = value
