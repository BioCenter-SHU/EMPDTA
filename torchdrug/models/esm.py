...
class EvolutionaryScaleModeling(nn.Module, core.Configurable):
    ...
    url = {
        ...
        "ESM-2_35M": "https://dl.fbaipublicfiles.com/fair-esm/models/esm2_t12_35M_UR50D.pt",
        "ESM-2_35M-regression": "https://dl.fbaipublicfiles.com/fair-esm/regression/esm2_t12_35M_UR50D-contact-regression.pt",
        "ESM-2_150M": "https://dl.fbaipublicfiles.com/fair-esm/models/esm2_t30_150M_UR50D.pt",
        "ESM-2_150M-regression": "https://dl.fbaipublicfiles.com/fair-esm/regression/esm2_t30_150M_UR50D-contact-regression.pt",
        "ESM-2_650M": "https://dl.fbaipublicfiles.com/fair-esm/models/esm2_t33_650M_UR50D.pt",
        "ESM-2_650M-regression": "https://dl.fbaipublicfiles.com/fair-esm/regression/esm2_t33_650M_UR50D-contact-regression.pt"
    }
    ...
    md5 = {
        ...
        "ESM-2_35M": "a894ddb31522e511e1273abb23b5f974",
        "ESM-2_35M-regression": "65666c891dcd90a9dc1b081042b7451b",
        "ESM-2_150M": "229fcf8f9f3d4d442215662ca001b906",
        "ESM-2_150M-regression": "539e6b14ee5fdb80db9501df9878649f",
        "ESM-2_650M": "ba6d997e29db07a2ad9dca20e024b102",
        "ESM-2_650M-regression": "743354dd846c9460fd2fe50892033543"
    }
    ...
    def forward(self, graph, input, all_loss=None, metric=None):
        ...
        input = functional.variadic_to_padded(input, size_ext, value=self.alphabet.padding_idx)[0]  # (batch_size, max_residues)

        # output = self.model(input, repr_layers=[33])
        # residue_feature = output["representations"][33]
        output = self.model(input, repr_layers=[30])  # for esm2-150M contains 30 layers
        residue_feature = output["representations"][30]
        # output = self.model(input, repr_layers=[12])  # for esm2-35M contains 12 layers
        # residue_feature = output["representations"][12]
