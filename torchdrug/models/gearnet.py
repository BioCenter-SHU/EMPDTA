...
class FusionNetwork(nn.Module, core.Configurable):
    ...
    def forward(self, graph, input, all_loss=None, metric=None):
        ...
        node_output1 = output1.get("node_feature", output1.get("residue_feature"))  # default: residue_feature 
        output2 = self.structure_model(graph, node_output1, all_loss, metric)
        node_output2 = output2.get("node_feature", output2.get("residue_feature"))  # default: residue_feature 
