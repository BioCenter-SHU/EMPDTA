...
sweep_configuration = {
    ...
    'parameters':
    {
        ...
        'num_epoch': {'values': [100]},
        'batch_size': {'values': [64]},
        'fold': {'values': [0]},  # 0, 1, 2
        'learning_rate': {'values': [1e-3]},
        'weight_decay': {'values': [1e-4]},
        'target_readout': {'values': ["sum"]},
        ...
        'loss_weight': {'values': [0.5]}  # 0.2, 0.5, 1.0, 2.0, 5.0
    }
}

sweep_id = wandb.sweep(sweep=sweep_configuration, project='AIO KIBA Sweep')
# sweep_id = "marinehdk/AIO KIBA Sweep/wnnhwtai"
...
def main():
    ...
    dataset = datasets.KIBA(protein_method="gearnetesm650m", drug_method="distanceMol", transform=transform)
    ...
    # model_checkpoint = "../../result/model_pth/POR_0420.pth"
    ...
    checkpoint = "../../result/model_pth/MD_AIO_Sweep_KIBA.pth"
